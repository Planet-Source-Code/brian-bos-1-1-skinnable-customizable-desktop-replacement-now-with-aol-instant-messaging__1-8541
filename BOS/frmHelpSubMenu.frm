...
Begin VB.Form frmHelpSubMenu 
   ...
   Begin VB.Label Label3 
      ...
      Caption         =   "GPL Liscence Restrictions"
      Height          =   255
      Left            =   60
      TabIndex        =   5
      Top             =   480
   ...
   Begin VB.Label Label1 
      BackStyle       =   0  'Transparent
      Caption         =   "BoS Vesion 1.1              2000 BSoft"
      Height          =   435
      Left            =   60
      TabIndex        =   1
      Top             =   60
...
Private Sub Label2_Click()
                ShellExecute Me.hWnd, "open", App.path & "\Installing.txt", "", "", 1
                s_Playsound "select"
                HideStartMenu
End Sub

Private Sub Label3_Click()
                ShellExecute Me.hWnd, "open", App.path & "\Copying.txt", "", "", 1
                s_Playsound "select"
                HideStartMenu
End Sub
...
Private Sub lblWebsite_Click()
                ShellExecute Me.hWnd, "open", "www.pokecenter2000.com", "", "", 1
                s_Playsound "select"
                HideStartMenu
End Sub
