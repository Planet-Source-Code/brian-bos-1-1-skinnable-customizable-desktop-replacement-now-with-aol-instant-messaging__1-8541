...
Public Sub HideStartMenu()
    ...
    If Translucent Then Blend frmTaskbar.picBstart, frmTaskbar.picDesktopCapture, TransLevel, 0, 0, frmTaskbar.picBstart.Width, frmTaskbar.picBstart.Height
